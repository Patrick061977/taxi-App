...
const attachments = [
    '2026-06-06_Sektion_U_Vergleich_Kurorte_und_Alternativen.pdf',
].map(name => ({
    filename: name,
...
anbei Sektion T der Weigel-Mappe: 'Vergleich Kurorte + Alternativen Tourismus vs § 42 PBefG /
...
transporter.sendMail({
    ...
    subject: 'Sektion U Weigel-Mappe: Vergleich Kurorte + Alternativen Tourismus vs § 42 — Doppel-Abzocke (06.06.2026)',
    text: body,
    attachments,
}).then(info => {
