...
// routet eigene Rechnungen → AUSGANG, Bar-Belege → KASSE, Booking.com → FEWO 2026.
            ...
            if (APPLY) {
                try {
                    ...
                    const info = await transporter.sendMail({
                        ...
                        to: target.email,
                        subject: `[Auto-GMX/${target.key}] ${fromAddr} — ${subject.slice(0, 60)}`,
